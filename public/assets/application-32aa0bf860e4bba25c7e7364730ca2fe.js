...
(function() {
  $(function() {
    return $("#add-band-form").click(function() {
      return $("#hidden-band-form").find(".band-form").clone().appendTo("#bands-section").find(".added").typeahead({
        hint: true,
        highlight: true,
        minLength: 2
      }, {
